declare module 'luxon' {
  ...
  declare type ToFormatOptions = {
    round: boolean,
  };
  declare type ISOTimeOptions = {
  ...
  declare class DateTime {
    ...
    static invalid(reason: *): DateTime;
  ...
  declare type DurationObjectShape = $Shape<DurationObject>;
  declare class Duration {
    ...
    static fromObject(object: DurationObjectShape & DurationOptions): Duration;
    ...
    set(values: DurationObjectShape): Duration;
    shiftTo(...units: string[]): Duration;
    toFormat(format: string, options?: ToFormatOptions): string;
    toISO(): string;
    toJSON(): string;
    toObject(options?: { includeConfig?: boolean }): DurationObjectShape & DurationOptions;
    toString(): string;
  }
  declare type EraLength = 'short' | 'long';
  declare type UnitLength = EraLength & 'numeric' | '2-digit' | 'narrow';
  declare type UnitOptions = InfoOptions & {
    numberingSystem?: string,
    outputCalendar?: string,
  };
  declare type InfoOptions = {
    locale?: string,
  };
  ...
  declare type IntervalObject = {
    start: DateTime,
    end: DateTime,
  }
  declare type IntervalObjectShape = $Shape<IntervalObject>;
  declare class Interval {
    ...
    set(values: IntervalObjectShape): Interval;
  ...
  declare type ZoneOffsetOptions = {
    format?: 'short' | 'long',
    localeCode?: string,
  };
